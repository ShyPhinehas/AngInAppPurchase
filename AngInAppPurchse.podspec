...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AngInAppPurchse.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/skyphinehas@hanmail.net/AngInAppPurchse'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'skyphinehas@hanmail.net' => 'montelia@naver.com' }
  s.source           = { :git => 'https://github.com/skyphinehas@hanmail.net/AngInAppPurchse.git', :tag => s.version.to_s }
